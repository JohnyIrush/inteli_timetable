      ...
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('/theme/assets/img/curved-images/curved0.jpg'); background-position-y: 50%;">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-6 text-center">
                <h1 class="display-3 text-white">Staff Menu</h1>
            </div>
            <div class="col-3"></div>
        </div>
        <div class="row justify-content-center ">
            ...
            <div class="col-2">
             <ul class="nav flex-column">
               ...
               <li class="nav-item">
                 <span class="nav-link-text ms-1 text-white">Attendance</span>
               </li>
             </ul>
            </div>
            ...
            <div class="col-2">
             <ul class="nav flex-column">
               ...
               <li class="nav-item">
                 <span class="nav-link-text ms-1 text-white">Designation</span>
               </li>
             </ul>
            </div>
            ...
            <div class="col-2">
             <ul class="nav flex-column">
               ...
               <li class="nav-item">
                 <span class="nav-link-text ms-1 text-white">Department</span>
               </li>
             </ul>
            </div>
            ...
            <div class="col-2">
             <ul class="nav flex-column">
               ...
               <li class="nav-item">
                 <span class="nav-link-text ms-1 text-white">Leave</span>
               </li>
             </ul>
            </div>
        </div>
